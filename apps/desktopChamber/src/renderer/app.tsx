...
// Visual shell geometry adapted from openchamber commit 8702c6d5cefa (MIT),
// Copyright (c) 2025 Bohdan Triapitsyn. See THIRD_PARTY_NOTICES.md.
...
import { OpenChamberDesktopShell } from "./openchamber/shell/index.ts";
...
import { Button, TooltipProvider } from "./ui/index.ts";
...
export function App() {
  ...
  return (
    <TooltipProvider>
      <div
        className="chamber-app-shell flex h-full flex-col bg-canvas font-sans text-sm text-fg"
        data-chamber-shell
      >
        {showConnect ? (
          ...
          <>
            ...
            {mobile ? (
              ...
              <div className="min-h-0 flex-1">
                <OpenChamberDesktopShell
                  sidebarOpen={!sidebarCollapsed}
                  sidebar={<AgenaSessionSidebar />}
                  header={null}
                  workspace={
