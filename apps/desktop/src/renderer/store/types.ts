// View-state contracts (desktop_plan.md §8, D-INV-5). Every shape here is
// produced ONLY by the pure reducers in this directory; components read, never
// mutate. Richer twin of packages/tui/src/store.ts under the same discipline:
// durable events finalize, frames touch in-flight only, malformed known
// payloads become marker blocks, unknown types never crash.
import type {
  ApprovalRequested,
  ApprovalResponse,
  ContentBlock,
